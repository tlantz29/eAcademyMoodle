...
class auth_plugin_mnet extends auth_plugin_base {
    ...
    function start_jump_session($mnethostid, $wantsurl, $wantsurlbackhere=false) {
        ...
        if ($mnet_session == false) {
            ...
            $mnet_session->districtid =$USER->districtid;
//            print_r($mnet_session);exit;
...
//var_dump($remoteuser); 
$district_id=intval($remoteuser->districtid); 
//  var_dump($remoteuser); exit;
        ...
        $localuser = $DB->get_record('user', array('username'=>$remoteuser->username, 'mnethostid'=>$remotehost->id,'districtid'=>$district_id));
//var_dump($localuser);exit;
        ...
        if (empty($localuser) || ! $localuser->id) {
            ...
            */
            ...
            $remoteuser->districtid = $district_id;
