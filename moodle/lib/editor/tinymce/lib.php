    ...
    protected function get_init_params($elementid, array $options=null) {
        ...
        $params = array(
			    'entities' => "", //added to try to fix
                    ...
                    'entity_encoding' => "raw",
                    'plugins' => "{$xmedia}advimage,safari,table,style,layer,advhr,advlink,emotions,inlinepopups,searchreplace,paste,directionality,fullscreen,moodlenolink,{$xemoticon}{$xdragmath}nonbreaking,insertdatetime,save,iespell,preview,print,noneditable,visualchars,xhtmlxtras,template,pagebreak",
                    ...
                    'theme_advanced_buttons3' => "bullist,numlist,outdent,indent,|,link,unlink,moodlenolink,|,image,hr,{$xemoticon}{$xmedia}{$xdragmath}nonbreaking,charmap",
